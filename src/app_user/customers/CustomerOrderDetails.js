        ...
        return (
            <View style={{ ...styles.container }}>
                ...
                <View style={{ flexDirection: 'column', position: 'absolute', zIndex: 1, top: 80, right: 20 }}>
                    <TouchableOpacity activeOpacity={0.7} onPress={() => Linking.openURL(`tel:${phoneNumber}`)}
                    ...
                    {/* {item.status == text.onTheWay &&
                        <TouchableOpacity onPress={() => this.props.navigation.navigate(navigate.ProviderMap)} activeOpacity={0.7} style={{ width: 40, height: 40, borderRadius: 100, alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', elevation: 5 }}>
                            <Ionicons name='location' size={20} />
                        </TouchableOpacity>
                    } */}
                </View>

                {/* <TouchableOpacity style={{ padding: 5, width: '80%', borderRadius: 10, marginHorizontal: 40, paddingVertical: 10, alignItems: 'center', justifyContent: 'center', alignSelf: 'center', backgroundColor: color.secondaryColor, elevation: 5, position: 'absolute', zIndex: 1, bottom: 10 }}>
